...
export default function Home() {
  ...
  async function handleSubmit(
    ...
    const personPrompt = `Generate a random poetry in urdu language for ${personName}. Their pronouns are ${personPronoun}. 
                          `

    const petPrompt = `Generate a random poetry in urdu language for ${petName} who is a pet ${petType}.
                       `

    const placePrompt = `Create a poetry in urdu language of gratitude based on the following category and topic name.`

    const thingPrompt = `Create a random poetry in urdu language based on the following thing and it's name.`
